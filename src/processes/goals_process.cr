...
require "../agents/primary_agent"

# This is the main process that runs once the primary agent is configured.
...
class GoalsProcess
  ...
  def initialize(@agent_configuration)
    #@primary_agent = PrimaryAgent.new(@agent_configuration.to_json)
    @openai_client = OpenAI::Client.new(api_key: @agent_configuration.openai_api_key, default_engine: @agent_configuration.fast_llm_model)
  end
  ...
  def run
    ...
    puts @openai_client.completions(prompt: prompt_text)
  end
end